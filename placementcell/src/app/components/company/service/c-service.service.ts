...
// for apply vacancy
Vacancyapply(Vacancy_ID: string): Observable<any> {
...
uploadNotice_Url( formData:any): Observable<HttpEvent<any>> {
  const req = new HttpRequest('POST', `${this.apiUrl}/uploadNotice_Url`, formData, {
    reportProgress: true,
    responseType: 'json'
  });
